...
void Cwalk(int i) {
    ...
    Cmonsters[i].Ct.move(Vector2f(Direction.x / (float)(abs(Direction.x) + abs(Direction.y)) * Cmonsters[i].speed * abs(Cdeltatime),
        Direction.y / (float)(abs(Direction.x) + abs(Direction.y)) * Cmonsters[i].speed * abs(Cdeltatime)));
