...
PauseMenu::PauseMenu(float width, float height)
{
    ...
    pausemenu[0].setPosition(Vector2f(width /2.5, height / 4));
    ...
    pausemenu[1].setPosition(Vector2f(width / 2.5, height / 4 + 200));
    ...
    pausemenu[2].setPosition(Vector2f(width / 2.5, height / 4 + 400));
